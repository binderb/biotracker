...
export default function PublishModal({ fallbackContents, buttonContents, showModal, setShowModal, saveChangesFunction, leadDetails, setLeadDetails, users, studyPlans, currentStudyPlanIndex, currentUser }: Props) {
