...
import { GET_CLIENTS, GET_LEADS, GET_STUDY_PLAN_FORMS, GET_STUDY_PLAN_FORM_LATEST, GET_USERS } from "@/utils/queries";
...
import CloneSetup from "@/components/leads/CloneSetup";
        ...
        <main className="flex items-top p-4">
          ...
          { (creatorStep === 3) &&
            <section id='step-3'>
              ...
              <div className='flex items-center mb-4'>
                Note that an official study (or studies) will NOT be created based on this draft until you or another authorized contributor decide to finalize it.
              </div>
